...
if (!$err) {
    ...
    if (!empty($userData) && $pdoStatement->rowCount() == 1) {
        ...
        echo "bad | received multiple rows (row count => " . $pdoStatement->rowCount() . ")";
    }
...
<div id="form-box">
    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input type="email" name="email" class="form-control" id="idEmailInput" placeholder="Entrez votre email" required>
        </div>
        <div class="form-group">
            <label for="idPasswordInput">Mot de passe</label>
            <input type="password" name="password" class="form-control" id="idPasswordInput" placeholder="Entrez votre mot de passe" required>
        </div>

...
<div id="middleWrapper">
    <div id="form-box">
        ...
        <form>
            ...
            <div class="form-group">
                <label for="idConfirmPasswordInput">Confirmer votre mot de passe</label>
                <input type="password" name="confirmpassword" class="form-control" id="idConfirmPasswordInput"
                       placeholder="Entrez votre mot de passe" required>
            </div>
            <button type="button" class="btn btn-primary" onclick="registerNewUser()">S'enregistrer</button>
        </form>
    </div>
</div>
